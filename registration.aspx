<%@ Page Language="C#"
    CodeFile="registration.aspx.cs" Inherits="_Default" Debug="true"%>
...
<div id="Regline2" class="RegLine"></div>
        <div id="div1-1" class="CourseEditLabelReg">
            ...
            <asp:TextBox ID="RegMail" runat="server" CssClass="CourseEditTBox" name="RegMail"></asp:TextBox>
        ...
        <asp:Button ID="RegSubmit" runat="server" class="button" Text="注册新帐号" onclick="RegSubmit_Click" OnClientClick="return CheckForm();" />
</form>
