...
public partial class _Default : System.Web.UI.Page
{
     ...
     protected void RegSubmit_Click(object sender, EventArgs e)
    {
        ...
        {
            sql = "insert into UserData (UserName, UserPW, Admin, CourseNum, MaxCourseNum, UserMail) values ('" + name + "','" + pw + "', 1, 0, '" + MaxCourseNum + "','" + mail + "')";
            ds = db.GetDataSet(sql);
            Response.Write("<script language='javascript'> alert('管理员帐号注册成功！'); </script>");
